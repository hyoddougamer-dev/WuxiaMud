...
| `docs/ORDEM.md` | **Começa por aqui.** A sequência de implementação, e porque é esta e não outra. |
| `docs/catalogue.png` | **Proposta.** Os 22 itens um a um, as marcas de grau por slot, e a tabela de stats refeita. |
